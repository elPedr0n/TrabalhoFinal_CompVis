SRC = src/main.cpp src/glad.c src/textrendering.cpp src/stb_image.cpp src/stb_image_write.cpp src/tiny_obj_loader.cpp src/tiny_gltf.cpp src/player.cpp src/buildtriangles.cpp src/animation.cpp src/projectiles.cpp src/particles.cpp src/enemies.cpp src/collectibles.cpp src/correcao.cpp src/gltf_utils.cpp src/screens.cpp src/breakables.cpp src/fragments.cpp src/gamepad.cpp src/sound.cpp src/collisions.cpp
