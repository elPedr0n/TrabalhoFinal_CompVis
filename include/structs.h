...
struct Player {
	...
	Player()
		: active_character(2), position(0.0f, -1.0f, 0.0f), speed(2.0f, 0.0f, 2.0f), rotate(0.0f), scale(1.0f), jumping(false), double_jump_available(false), health(100.0f), max_health(100.0f), is_dead(false), death_timer(0.0f), is_flinching(false), flinch_timer(0.0f)
	{
